    ...
    public void startTutorial(){
       ...
       Tooltip.TooltipView tooltipView1= Tooltip.make(this,
                new Tooltip.Builder(101)
                        ...
                        .floatingAnimation(Tooltip.AnimationBuilder.DEFAULT)
                        .text("This here is activity_summary pie chart of the percentage spoken")
                        .showDelay(3000)
                        .maxWidth(600)
                        .withArrow(true)
                        .withOverlay(true).build()
        ...
        Tooltip.TooltipView tooltipView2 = Tooltip.make(this,
                new Tooltip.Builder(101)
                        ...
                        .floatingAnimation(Tooltip.AnimationBuilder.DEFAULT)
                        .text("This here is activity_summary piano roll of time spoken per person")
                        .activateDelay(0)
                        .showDelay(6000)
                        .maxWidth(600)
                        .withArrow(true)
       ...
       Tooltip.TooltipView tooltipView3= Tooltip.make(this,
                new Tooltip.Builder(101)
                        ...
                        .floatingAnimation(Tooltip.AnimationBuilder.DEFAULT)
                        .text("This here is activity_summary audio playback to listen to the conversation")
                        .activateDelay(0)
                        .showDelay(9000)
                        .maxWidth(600)
                        .withArrow(true)
